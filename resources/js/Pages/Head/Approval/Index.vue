                                ...
                                <tr class="bg-white border-b hover:bg-gray-50" v-else v-for="(approval, index) in approvals">
                                    ...
                                    <td class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">
                                        <div v-if="approval.is_approved === null">
                                            <Link :href="`/head/approval/${approval.id}/approve`" method="patch" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Setujui</Link>
                                            <Link :href="`/head/approval/${approval.id}/reject`" method="patch" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Tolak</Link>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
